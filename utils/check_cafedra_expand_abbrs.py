    ...
    for i in range(len(origin)):
        ...
        if oni != eni:
            ...
            '''skip_check = [
                ...
                'МОСКОВСКАЯ', 'НИЖЕГОРОДСКАЯ', 'НОВГОРОДСКАЯ', 'ПИНСКАЯ', 'ПСКОВСКАЯ', 'РЯЗАНСКАЯ',
                'СЕВЕРОДОНЕЦКАЯ', 'СМОЛЕНСКАЯ', 'ХОЛМСКАЯ', 'ЯРОСЛАВСКАЯ',
...
def header_like(origin_header, expanded_header):
    ...
    manual = {
        ...
        # Запятая перед обн.
        'АЛДАНСКАЯ, обн. (см. Рухловская обн.)' : 'АЛДАНСКАЯ, обновленческая (см. Рухловская, обновленческая)'
    }
