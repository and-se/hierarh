...
!!!! григорианский в названиях кафедр (так в списке сокращений), хотя надо бы "григорианская"
...
* СМОЛЕНСКАЯ
* ТАЛЛИНСКАЯ
* ФЕОДОСИЙСКАЯ - здесь вообще все сноски утеряны

== Прочие проблемы ==

!!!! (см.) раскрывает (смотри) - так в списке сокращений, но так непонятно.
