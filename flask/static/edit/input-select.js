...
suggest-функция принимает на вход ввод пользователя
(+ необязательно signal для отмены запроса и сам тег input-select)
и возвращает список подсказок в виде массива строк либо объектов (можно Promise)
